    ...
    <table class="table table-borderless table-responsive card-1 p-4">
        ...
        <?php foreach ($actividades as $actividade) : ?>
            <tr class="border-bottom">
                ...
                <td>
                    <div class="p-2 icons">
                    <?= $this->Html->link(__('Editar Actividad'), ['action' => 'edit', $actividade->id]) ?>
                        <?= $this->Form->postLink(__('Eliminar Actividad'), ['action' => 'delete', $actividade->id], ['confirm' => __('Are you sure you want to delete # {0}?', $actividade->id)]) ?>
