        ...
        <div class="container">
            <div class="row">
                ...
                <?php foreach ($noticias as $noticia): ?>
                    <div class="blog-item">
                        <div class="bi-pic">
                        <?= $this->Html->image($noticia->image, ['alt' => 'Imagen', 'action' => 'view', $noticia->titulo]);?>
                        </div>
                        <div class="bi-text">
                            <h5><?= $this->Html->link($noticia->titulo, ['action' => 'view', $noticia->titulo]) ?></h5>
                            <ul>
                                <li>by Admin</li>
                                <li><?= $noticia->fecha_creacion->format(DATE_RFC850) ?></li>
                                <li>20 Comment</li>
                            </ul>
                            <p><?= ($noticia->texto) ?></p>
