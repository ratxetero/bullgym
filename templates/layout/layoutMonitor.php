        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <nav class="nav-menu">
                    ...
                    <li><?php echo $this->Html->link('Gestion de actividades', ['controller' => 'Actividades', 'action' => 'misactividades']) ?></li>
                    <li><?php echo $this->Html->link('Gestion de rutinas', ['controller' => 'Rutinas', 'action' => 'misrutinas']) ?></li>
                    </ul>
                </li>
