                    ...
                    <nav class="nav-menu">
                        <ul>
                            ...
                            <?php if ($this->Identity->isLoggedIn()) :  ?>
                                <li><?php echo $this->Html->link('Mi suscripción', ['controller' => 'Users', 'action' => 'Pagar']) ?></li>
                                <li><?php echo $this->Html->link('Mis Reservas', ['controller' => 'Actividades', 'action' => 'misreservas']) ?></li>
                                <li><?php echo $this->Html->link('Rutinas', ['controller' => 'Rutinas', 'action' => 'index']) ?></li>
